  ...
  return (
    <header 
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        isScrolled 
          ? 'bg-[#080A0D]/95 backdrop-blur-[18px] border-b border-[#252C33] shadow-[0_8px_30px_rgba(0,0,0,0.7)] py-3' 
          : 'bg-[#080A0D]/75 backdrop-blur-[18px] border-b border-[#252C33]/60 py-3.5'
      }`}
    >
