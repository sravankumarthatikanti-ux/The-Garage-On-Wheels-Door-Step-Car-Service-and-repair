  ...
  return (
    <div className="hidden lg:block fixed bottom-6 left-6 z-40 transition-all duration-300 animate-fadeIn">
      <button
        ...
        className="px-6 py-3.5 btn-sport-primary font-black text-xs uppercase tracking-widest rounded-full shadow-2xl flex items-center space-x-2 active:scale-95 group border border-ice/50"
