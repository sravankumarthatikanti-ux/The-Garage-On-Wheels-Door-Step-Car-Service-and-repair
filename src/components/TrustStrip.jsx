...
export default function TrustStrip() {
  ...
  return (
    <section className="bg-[#101419] border-y border-[#252C33] py-4 sm:py-5 relative z-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 items-center">
          {points.map((pt, idx) => {
            ...
            return (
              ...
              >
                <div className="w-10 h-10 rounded-xl bg-[#181E24] border border-[#252C33] flex items-center justify-center shrink-0 shadow-sm">
                ...
                <div className="text-left">
                  ...
                  <p className="text-xs text-[#A7ADB4] font-medium font-sans">
                    {pt.subtitle}
                  </p>
                </div>
              </div>
